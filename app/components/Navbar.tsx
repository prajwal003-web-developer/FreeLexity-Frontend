...
const Navbar = () => {
  ...
  return (
    <nav className='py-3 fixed top-0 left-0 right-0 px-3 flex justify-between items-center bg-white z-30 border-b border-solid border-gray-400'>
        <Link className='text-center w-fit text-lg flex flex-row justify-center items-center md:text-xl select-none cursor-pointer font-bold bg-gradient-to-l from-pink-600 to-orange-500 via-gray-800 bg-clip-text text-transparent' href={'/'}>  FREELEXITY <GiAirZigzag color='orange' /></Link>
